    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: conversation_1.Conversation.name, schema: conversation_1.ConversationSchema },
            ]),
        ],
        controllers: [conversation_controller_1.ConversationController],
        providers: [chat_gateway_1.ChatGateway, conversation_service_1.ConversationService],
        exports: [chat_gateway_1.ChatGateway, conversation_service_1.ConversationService],
    })
], ConversationModule);
