...
let Share = class Share extends aggregate_root_schema_1.AggregateRoot {
};
exports.Share = Share;
__decorate([
...
exports.Share = Share = __decorate([
    (0, mongoose_1.Schema)({
        timestamps: true,
        collection: constants_1.COLLECTION_NAMES.SHARE,
    })
], Share);
exports.ShareSchema = mongoose_1.SchemaFactory.createForClass(Share);
exports.ShareSchema.plugin(autopopulate_soft_delete_1.default);
