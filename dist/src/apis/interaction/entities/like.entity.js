...
let Like = class Like extends aggregate_root_schema_1.AggregateRoot {
};
exports.Like = Like;
__decorate([
...
exports.Like = Like = __decorate([
    (0, mongoose_1.Schema)({
        timestamps: true,
        collection: constants_1.COLLECTION_NAMES.LIKE,
    })
], Like);
exports.LikeSchema = mongoose_1.SchemaFactory.createForClass(Like);
exports.LikeSchema.plugin(autopopulate_soft_delete_1.default);
